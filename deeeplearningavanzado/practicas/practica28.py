# -*- coding: utf-8 -*-
"""
Created on Mon Dec 15 09:14:58 2025
...
LOG_DIR = 'C:/Users/jesus/IA/machinelearning/machinelearningbook/archivos/cursodatasets/Datasets/keras_log'
...
history = model.fit(x_train, y_train, validation_data=(x_valid, y_valid), epochs=10, batch_size=128, callbacks=[tensorboard_callback])
