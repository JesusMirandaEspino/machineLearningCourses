# -*- coding: utf-8 -*-
"""
Created on Fri Nov  7 14:16:16 2025
...
# Importar el dataset
dataset = pd.read_csv("C:/Users/jesus/IA/machinelearning/machinelearningbook/archivos/curso4/Credit_Card_Applications.csv")
...
x_pred_test  =  y_pred[:,0]
y_pred_test  =  y_pred[:,1]

value_range = list(range(1, 691))
plt.scatter(x_pred_test, y_pred_test)
